...
dependencies {
    ...
    // Exo player
    val exo_player = "1.2.0"
    implementation("androidx.media3:media3-exoplayer:$exo_player")
    implementation("androidx.media3:media3-exoplayer-dash:$exo_player")
    implementation("androidx.media3:media3-ui:$exo_player")
